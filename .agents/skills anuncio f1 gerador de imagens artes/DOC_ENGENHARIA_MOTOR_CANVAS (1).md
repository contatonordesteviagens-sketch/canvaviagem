...
> `TOTAL_VARIANTS = 9` → índices válidos `0..8`.
...
| **V6** | Split Bottom | Foto 65% topo / faixa sólida 35% rodapé dividida em 2 colunas | ✅ | ✅ (parametrizado) | ✅ |
| **V7** | Scale 0.85 | Variação com escala de renderização reduzida em 15% a pedido do usuário | ✅ | ✅ (parametrizado) | ✅ |
| **V8** | Luxury Experience | Foto full-bleed, chamada solta no topo, preço em caixa escura, CTA e destaques na base | ✅ | ✅ (parametrizado) | ✅ |
...
1. Confirmar próximo índice livre (atual: **V9**).
