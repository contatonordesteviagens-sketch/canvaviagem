...
import { User, Building2, Phone, Link as LinkIcon, Check, Save, ShieldCheck, Zap, Info, Wallet } from 'lucide-react';
        ...
        <section className="space-y-4 sm:space-y-6">
          <div className="bg-[#111114] border border-white/[0.05] rounded-2xl sm:rounded-[32px] p-5 sm:p-8 shadow-xl">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-500/10 flex items-start gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] leading-relaxed text-[#8a8a8f]">
                    A IA utilizada é o <strong>Gemini 1.5 Flash</strong>, otimizado para baixo custo. O custo por mensagem é aproximadamente <strong>R$ 0,0004</strong> (menos de um centavo). 
                  </p>
                </div>
              </div>
              ...
              <p className="text-[10px] text-[#5a5a5f] italic text-center px-4">
                * Valores baseados na cota atual do Google AI Studio em dólar convertido para Real.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#111114] border border-white/[0.05] rounded-2xl sm:rounded-[32px] p-5 sm:p-8 shadow-xl">
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <LinkIcon className="size-3.5 sm:size-4 text-blue-400" />
              <h2 className="text-[10px] sm:text-[11px] font-black text-white uppercase tracking-widest">Link de Acesso</h2>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <div className="flex-1 bg-white/[0.03] border border-white/[0.05] rounded-xl sm:rounded-2xl px-4 py-3 text-[11px] sm:text-xs font-medium text-[#8a8a8f] truncate">
                {window.location.origin}
              </div>
              <button 
                onClick={copyLink}
                className={cn(
                  "flex items-center justify-center gap-2 px-6 py-3 rounded-xl sm:rounded-2xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 border min-w-[120px] sm:min-w-[140px]",
                  copiedLink 
                    ? "bg-emerald-500 text-white border-emerald-400" 
                    : "bg-blue-600 text-white border-blue-500 hover:bg-blue-500 shadow-lg shadow-blue-600/20"
                )}
              >
                {copiedLink ? (
                  <>
