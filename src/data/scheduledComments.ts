...
export const DEFAULT_SCHEDULED_COMMENTS: ScheduledComment[] = [
  ...
  { time: "02:52", username: "LeoMundoAfora", message: "Nossa que top essa explicação!" },
  { time: "02:57", username: "SandraRoteiros", message: "Muito bom, já estou anotando as ideias!" },
  { time: "03:02", username: "ThiagoMochileiro", message: "Conteúdo excelente e áudio nota 10!" },
  { time: "03:25", username: "GuiDoDestino", message: "Lucas sempre entregando muito valor nas lives!" },
  { time: "03:39", username: "ValdirTur", message: "Sensacional, vai me ajudar demais no feed!" },
  { time: "04:03", username: "KarinaViagens", message: "Qualidade do vídeo está incrível, muito boa a aula!" },
  { time: "04:10", username: "Let_Viajante", message: "Esses criativos economizam muito tempo" },
  ...
  { time: "05:28", username: "LeticiaViajante", message: "Fica muito profissional com essa identidade visual!" },
  { time: "05:42", username: "CarlaTurismo", message: "Já quero aplicar isso hoje mesmo no meu insta!" },
  { time: "05:59", username: "PedroViagens", message: "Excelente aula, Lucas! Muito bem explicado tudo." },
