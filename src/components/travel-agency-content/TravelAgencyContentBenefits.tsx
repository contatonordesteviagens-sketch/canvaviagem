      ...
      <section className="relative overflow-hidden border-t border-white/[0.04] bg-[#08080b] px-5 py-20 text-[#f5f5f7] sm:px-8 lg:py-[76px]">
        ...
        <div className="relative mx-auto max-w-[1270px]">
          ...
          <div className="mt-9 space-y-8 sm:mt-10 sm:space-y-10">
            <p className="qorvo-reveal max-w-[1160px] text-[clamp(1.55rem,2.55vw,2.15rem)] font-[650] leading-[1.28] tracking-[-0.035em]">Não é o <span className="inline-block rounded-[9px] border border-[#7c5cff]/55 bg-[#7c5cff]/10 px-2.5 py-0.5 text-[#987cff]">Canva</span>. Você não arrasta nada. Escolhe o modelo, informa a viagem e recebe o carrossel pronto para revisar.</p>
            <p className="qorvo-reveal max-w-[1160px] text-[clamp(1.55rem,2.55vw,2.15rem)] font-[650] leading-[1.28] tracking-[-0.035em]">Não é <span className="inline-block rounded-[9px] border border-[#7c5cff]/55 bg-[#7c5cff]/10 px-2.5 py-0.5 text-[#987cff]">agência</span>. A ferramenta prepara as peças; sua equipe revisa e publica.</p>
            <p className="qorvo-reveal max-w-[1100px] text-[clamp(1.55rem,2.55vw,2.15rem)] font-[650] leading-[1.28] tracking-[-0.035em]">Não é <span className="inline-block rounded-[9px] border border-[#7c5cff]/55 bg-[#7c5cff]/10 px-2.5 py-0.5 text-[#987cff]">template genérico</span>. Os +12 modelos foram estruturados para turismo.</p>
            <p className="qorvo-reveal max-w-[1080px] text-[clamp(1.55rem,2.55vw,2.15rem)] font-[650] leading-[1.28] tracking-[-0.035em]">Não <span className="inline-block rounded-[9px] border border-[#7c5cff]/55 bg-[#7c5cff]/10 px-2.5 py-0.5 text-[#987cff]">publica sozinha</span>. Você exporta e escolhe quando colocar no Feed ou nos Stories.</p>
          </div>
        </div>
      </section>
    </>
