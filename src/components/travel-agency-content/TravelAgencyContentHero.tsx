...
const metrics = [
  ["10 modelos", "CARROSSÉIS PARA TURISMO"],
  ["3 formatos", "FEED, QUADRADO E STORIES"],
  ["Vários slides", "CAPAS, CONTEÚDO E CHAMADAS"],
  ["1 fluxo", "ESCOLHA, PERSONALIZE E EXPORTE"],
] as const;
      ...
      <section id="inicio" aria-labelledby="travel-agency-hero-title" className="relative isolate overflow-hidden bg-[#08080b] text-[#f5f5f7]">
        ...
        <div className="mx-auto max-w-[1200px] px-5 pb-6 pt-[150px] sm:px-7 lg:pt-[178px]">
          <div className="grid items-center gap-14 lg:grid-cols-[.98fr_1.02fr] lg:gap-12">
            ...
            <div className={`relative min-h-[570px] transition-[opacity,transform] delay-150 duration-1000 lg:min-h-[610px] ${visible ? "translate-y-0 opacity-100" : "translate-y-7 opacity-0"}`}>
              <div className="absolute inset-x-[2%] top-[9%] h-[68%] overflow-hidden rounded-[32px] border border-[#9b82ff]/20 bg-[#0a0912] shadow-[0_38px_110px_rgba(0,0,0,.7),0_0_70px_rgba(124,92,255,.18)]">
              ...
              <img src={`${A}cancun-card-02.png`} alt="Carrossel de viagem criado para Cancún" className="absolute left-0 top-[2%] aspect-[4/5] w-[25%] -rotate-[7deg] rounded-xl border border-white/15 object-cover shadow-2xl" />
              <img src={`${A}gramado-offer-05.png`} alt="Arte vertical de turismo para Stories" className="absolute bottom-[1%] right-0 aspect-[4/5] w-[24%] rotate-[7deg] rounded-xl border border-white/15 object-cover shadow-2xl" />
              <p className="absolute bottom-[12%] left-[12%] rounded-full border border-[#22d3a8]/25 bg-[#09090dcc] px-4 py-2 font-mono text-[9px] uppercase tracking-[.16em] text-[#22d3a8] backdrop-blur">do destino ao post em poucos cliques</p>
            </div>
          </div>

          <div className="relative mt-8 h-[490px] overflow-hidden border-y border-white/[.07] sm:h-[570px]">
