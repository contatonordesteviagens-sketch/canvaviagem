  ...
  return (
    <div className="w-full aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1] rounded-lg relative font-sans overflow-hidden" style={{ background: "#03070F" }}>
      <img
        ...
        className="h-full w-full pointer-events-none select-none object-cover opacity-70"
        style={{ maskImage: "linear-gradient(to bottom, transparent, white 10%, white 90%, transparent)", WebkitMaskImage: "linear-gradient(to bottom, transparent, white 10%, white 90%, transparent)" }}
        alt="world map"
        draggable={false}
      />
      <svg
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-[10px] md:text-xs font-bold px-2 py-0.5 rounded-md bg-black/80 text-white border border-white/10 shadow-sm backdrop-blur-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
              ...
              <g key={`end-${i}`}>
                ...
                {showLabels && dot.end.label && (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-[10px] md:text-xs font-bold px-2 py-0.5 rounded-md bg-black/80 text-[#00E5FF] border border-[#00E5FF]/30 shadow-sm backdrop-blur-sm">
                          {dot.end.label}
                        </span>
                      </div>
                    </foreignObject>
