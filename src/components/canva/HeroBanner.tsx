...
export const HeroBanner = ({
  ...
  return <div className="relative overflow-hidden rounded-3xl mb-6">
      {/* Gradient Background */}
      <div className="bg-hero-gradient py-10 px-6 md:py-16 md:px-10">
        ...
        <div className="absolute top-1/3 right-8 text-2xl opacity-70">🗺️🏖️</div>
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="max-w-lg mx-auto relative">
            <div className="relative">
              ...
              <Input type="search" placeholder="Busque conteúdo seu ou do Canva" value={searchValue} onChange={e => onSearchChange(e.target.value)} className="w-full pl-12 pr-4 h-14 rounded-full bg-white shadow-lg border-0 text-foreground placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-white/50" />
            </div>
          </div>
        </div>
      </div>
