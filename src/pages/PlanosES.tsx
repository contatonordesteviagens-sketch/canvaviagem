      ...
      >
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="space-y-4">
            ...
            >
              {isGenerating ? <Loader2 className="w-5 h-5 animate-spin" /> : (activeTab === 'pix' ? "Pagar vía Moneda Local" : "Pagar com Cart├úo")}
            </button>
    ...
    try {
      ...
      toast.error(
        <div className="flex flex-col gap-2">
          ...
          >
            Clique Aqui para Pagar vía Moneda Local →
          </a>
        </div>,
        { duration: 10000 }
      );
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          ...
          <div className="mt-8 border border-zinc-200 rounded-2xl p-8 text-center">
            ...
            <h2 className="text-2xl font-black mb-2">Eres Premium ✔️</h2>
            <p className="text-zinc-500 mb-4">
              {subscription.subscriptionEnd
                ? `Tu suscripción está activa hasta ${new Date(subscription.subscriptionEnd).toLocaleDateString("pt-BR")}.`
            ...
            <div className="mb-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-5 text-left">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-black text-black">Novo: Plan Elite</span>
            ...
            <div className="flex flex-col gap-3">
              <Button className="bg-black text-white hover:bg-zinc-800 h-12 rounded-xl font-bold" onClick={() => navigate("/")}>
                <Plane className="mr-2 h-4 w-4" /> Acceder a la Plataforma
              </Button>
              <div className="flex gap-3">
                <Button variant="outline" className="flex-1 border-zinc-200 rounded-xl" onClick={handleManageSubscription} disabled={portalLoading}>
                  {portalLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <><Settings className="mr-2 h-4 w-4" />Gestionar</>}
                </Button>
                <Button variant="ghost" className="flex-1 rounded-xl" onClick={handleRefreshSubscription} disabled={refreshLoading}>
                  {refreshLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <><RefreshCw className="mr-2 h-4 w-4" />Actualizar Estado</>}
                </Button>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-yellow-500/30 font-sans">
      ...
      <MinimalistHero
        ...
        overlayText={{ part1: 'VENDE', part2: 'MÁS' }}
        theme="light"
      />
      ...
      <section className="py-12 px-4 md:px-6 bg-zinc-50 border-b border-zinc-100">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-[10px] font-black tracking-[0.3em] text-cyan-600 uppercase mb-2">VISUALIZA EL RESULTADO</p>
            <h2 className="text-2xl md:text-4xl font-black italic uppercase tracking-tighter leading-tight mb-3 text-black">
              Tu feed se verá <span className="text-zinc-400 underline decoration-black/20">exactamente así</span>
            </h2>
          </div>
          
          <div className="grid grid-cols-3 gap-2 md:gap-6 max-w-3xl mx-auto">
            {[
              { title: "Florianópolis - SC", img: "https://images.unsplash.com/photo-1583073171552-19c39d771d45?w=400&q=80", label: "5 Mejores Playas de Floripa" },
              { title: "Paris", img: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=400&q=80", label: "PARÍS: LA CIUDAD DEL AMOR" },
              { title: "Jericoacoara - CE", img: "https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=400&q=80", label: "¡VEN A JERICOACOARA!" }
            ].map((card, i) => (
      ...
      <section className="py-12 px-4 md:px-6 bg-white border-b border-zinc-100 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-10">
            <p className="text-[10px] font-black tracking-[0.3em] text-cyan-600 uppercase mb-2">LA MAGIA DETRÁS DEL CÓDIGO</p>
      ...
      <section className="py-10 px-4 md:px-6 bg-zinc-950">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
            {[
              "BAIXAS VENDES", "INCONSIST├èNCIA", "POUCOS SEGUIDORES", "FALTA DE TEMPO",
      ...
      <section className="bg-black text-white pt-14 pb-12 px-4 md:px-6 text-center relative">
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <p className="text-zinc-500 text-base font-bold italic mb-10 uppercase tracking-widest opacity-50">
            Acesso imediato. Garantía de 7 días. Sem risco.
          </p>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)' }}>ÔÜí Acceso en 2 min</span>
            </div>
          </div>
        </div>
      </section>
