...
const NICHES_BY_AGENCY: Partial<Record<AgencyType, NicheOption[]>> = {
  ...
  corporativa: [
    { id: "internacional", label: "Viajes Internacionales Ejecutivos", emoji: "✈️" },
  ...
  religioso: [
    { id: "internacional", label: "Tierra Santa", emoji: "🕊️" },
    { id: "luademel", label: "Fátima y Santuarios (Europa)", emoji: "⛪" },
    { id: "sul", label: "Santuarios Nacionales", emoji: "🙏" },
    { id: "aventura", label: "Camino de Santiago", emoji: "🥾" },
    { id: "nordeste", label: "Rutas de Peregrinación", emoji: "✝️" },
  ...
  cruzeiros: [
    ...
    { id: "luademel", label: "Cruceros Mediterráneo", emoji: "🛳️" },
...
const DiagnosticoResult = ({ onNext, onBack, onEdit }: { onNext: () => void; onBack: () => void; onEdit: () => void }) => {
  ...
  const handleSave = () => {
    ...
    saveMutation.mutate({
      ...
      onSuccess: () => toast.success("✅ ¡Diagnóstico guardado en tu cuenta!"),
    });
  };
