      ...
      <section id="comparativo" className="py-24 px-6 bg-white text-black">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#405466] max-w-2xl mx-auto">No te engañaremos comparándote con una agencia de diseño de R$10.000. Analiza las alternativas reales que estás considerando.</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[700px]">
              ...
              <tbody className="text-[#0e1318]">
                {[
                  { l: "Inversión", a: "R$ 197 (pago único)", b: "R$ 1500/mes", c: "Desde R$ 197/año" },
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-center gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex-1 bg-white border border-[#d4d8db] rounded-2xl p-8 flex flex-col justify-between shadow-sm">
              <div className="mb-8">
                ...
                <div className="flex items-baseline gap-1 mb-2 text-[#0e1318]">
                  ...
                  <span className="text-[#405466] text-base font-normal">/mes</span>
                </div>
                <p className="text-sm text-[#405466]">
                  {billingPeriod === 'monthly' ? 'Suscripción mensual recurrente' : 'Equivalente a R$ 197.00 anuales'}
                </p>
              </div>
            ...
            <div className="flex-1 bg-white border-[3px] border-[#8b3dff] rounded-2xl p-8 flex flex-col relative shadow-[0_10px_30px_rgba(139,61,255,0.15)] md:-mt-4 md:mb-4">
              ...
              <div className="mb-8">
                ...
                <p className="text-sm text-[#405466]">
                  {billingPeriod === 'monthly' ? 'Suscripción mensual recurrente' : 'Equivalente a R$ 347.00 anuales (Ahorro considerable)'}
                </p>
              </div>
