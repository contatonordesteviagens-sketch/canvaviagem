...
const INITIAL_COMMENTS: Comment[] = [
  { id: "1", username: "carlos_viajes", message: "¡Vamos con todo gente!", time: "22:40" },
  { id: "2", username: "mariatorres_travel", message: "Hola a todos 👋", time: "22:41" },
  { id: "3", username: "diego89_turismo", message: "Sí, se escucha perfecto", time: "22:41" },
  { id: "4", username: "luisagente", message: "Excelente transmisión", time: "22:42" },
  { id: "5", username: "fer_viajes_latam", message: "Fernando desde Santiago escuchando perfecto", time: "22:42" },
  { id: "6", username: "andreajones_tours", message: "¡Lista para aprender a fabricar ofertas! 🚀", time: "22:43" },
  { id: "7", username: "pablo_marketing", message: "Se ve genial", time: "22:43" },
  { id: "8", username: "julio_agencia", message: "¡Sí, listo!", time: "22:44" },
];

const AUTO_COMMENTS_POOL = [
  { username: "veronica_viajes", message: "¡Estoy sorprendida con la velocidad de este generador! 😱" },
  { username: "rober_turismo", message: "¿Puedo cambiar el logo y los colores para el cliente?" },
  { username: "sofi_travels", message: "Sí, es súper fácil en Canva, ya lo probé." },
  { username: "agente_premium_es", message: "Esto me va a ahorrar al menos 10 horas de trabajo a la semana." },
  { username: "lucas_viajero", message: "El audio y video están impecables." },
  { username: "carla_es", message: "¡Ya soy miembro Elite y lo recomiendo al 100%!" },
  { username: "marcos_turismo", message: "¡A vender paquetes de viajes! ✈️" },
  { username: "patricia_travels", message: "¿Se puede exportar en PDF y JPG también?" },
  { username: "diego_ventas", message: "Una maravilla esta herramienta." },
  { username: "lorena_agencia", message: "¿Se puede usar en celular o solo en computadora?" },
  { username: "valentin_tours", message: "¡La mejor inversión que he hecho este año!" },
  { username: "agencia_viva_es", message: "Los anuncios son de alta conversión, mis campañas mejoraron mucho." },
  { username: "beatriz_viajera", message: "¿Cómo hago para acceder a los bonos de la Fábrica?" },
  { username: "murilo_mkt", message: "¡Muy bueno ver el paso a paso en la práctica!" },
];
...
const LiveStreamES = () => {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setNewComment("");
    toast.success("¡Mensaje enviado al chat en vivo!");
  };
      ...
      <header className="border-b border-zinc-800/80 bg-zinc-900/90 backdrop-blur-md px-6 py-4 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-400 uppercase tracking-widest font-bold">Panel de Acceso Interno</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <span className="h-2.5 w-2.5 rounded-full bg-cyan-400 animate-pulse" />
          <span className="text-xs font-bold uppercase tracking-wider text-cyan-400 hidden sm:inline">Servidor de Transmisión Activo</span>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800/80 rounded-2xl p-4 md:p-5 flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="text-xl md:text-2xl font-black text-white leading-snug">
                ¡La Fábrica de Anuncios crea un Low Ticket por HORA!
              </h2>
            </div>
            <div className="flex items-center gap-1.5 bg-red-600/10 border border-red-500/20 px-3 py-1.5 rounded-xl flex-shrink-0 animate-pulse">
              ...
              <span className="text-[11px] font-black text-red-500 uppercase tracking-wider">En Vivo</span>
            </div>
          </div>
          ...
          <div className="bg-zinc-900/35 border border-zinc-800/50 rounded-2xl p-5 text-sm text-zinc-400 leading-relaxed">
            ...
            <p>
              En esta clase exclusiva demostrativa para acceso interno, mostramos el engranaje perfecto de generación de 
              <strong> La Fábrica de Anuncios</strong>. Descubre cómo estructurar ofertas, embudos de alta conversión y campañas 
              completas de viajes en minutos, garantizando escala automática y ventas recurrentes.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col h-[600px] lg:h-[680px] bg-zinc-900/60 border border-zinc-800/80 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="flex p-2 bg-zinc-900 border-b border-zinc-800/80 gap-1">
            ...
            <button
              onClick={() => {
                ...
                toast.info("¡Canal de soporte cargado con éxito!");
              }}
              className={`flex-1 py-3 px-4 rounded-2xl text-xs font-black tracking-wider uppercase transition-all duration-300 ${
                activeTab === "support"
                  ? "bg-white text-black shadow-lg"
          ...
          {activeTab === "chat" ? (
            <div className="flex-1 flex flex-col justify-between overflow-hidden">
              ...
              <form onSubmit={handleSendMessage} className="p-4 border-t border-zinc-800/80 bg-zinc-900/60 flex items-center gap-2">
                <Button
                  ...
                  onClick={() => toast.success("Adjuntar archivos solo disponible en soporte")}
                >
                  <Paperclip size={18} />
                </Button>
                ...
                <Button
                  ...
                  size="icon"
                  className="rounded-xl text-zinc-400 hover:text-white hover:bg-zinc-800"
                  onClick={() => toast.info("Selector de emojis en desarrollo")}
                >
                  <Smile size={18} />
                </Button>
            ...
            <div className="flex-1 p-6 flex flex-col items-center justify-center text-center gap-6 animate-scale-in">
              ...
              <div>
                <h3 className="text-lg font-black text-white uppercase tracking-wider mb-2">Canal de Soporte Activo</h3>
                <p className="text-xs text-zinc-400 max-w-xs mx-auto leading-relaxed">
                  ¿Necesitas asistencia técnica o comercial inmediata? Nuestros asistentes están de guardia para ayudarte a configurar tu acceso.
                </p>
              </div>
              <a
                href="https://wa.me/5585986411294?text=Hola,%20estoy%20viendo%20la%20Live%20de%20la%20Fábrica%20y%20necesito%20soporte."
                target="_blank"
              ...
              <div className="flex items-center gap-1.5 text-[10px] text-zinc-500 uppercase tracking-widest font-black mt-2">
                <AlertCircle size={12} />
                Tiempo de respuesta menor a 2 min
              </div>
            </div>
          )}
