...
const LiveStream = () => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    // Simulate loading/C spinner like in reference
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sans select-none justify-center">
      ...
      {step === "register" ? (
        ...
        /* PASSO 2: PLAYER DA LIVE COM CHAT */
        <main className="flex-1 max-w-7xl w-full mx-auto p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            {/* PLAYER DE VÍDEO COM CAPA DE CLICK-TO-PLAY */}
            <div className="relative aspect-video rounded-3xl overflow-hidden bg-black border border-zinc-800/80 shadow-[0_24px_50px_rgba(0,0,0,0.5)]">
              ...
              {!isPlaying ? (
                ...
                /* EMBED DO VÍDEO VSL DA PÁGINA DE PLANOS COM AUTOPLAY E SOM ATIVOS APÓS O CLIQUE */
                <iframe
      ...
      {step === "watch" && (
        <footer className="border-t border-zinc-900 py-3 bg-zinc-950 flex items-center justify-center gap-6 text-[10px] text-zinc-500 uppercase font-black tracking-wider">
