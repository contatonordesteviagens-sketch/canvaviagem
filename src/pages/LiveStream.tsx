...
const SCHEDULED_COMMENTS: ScheduledComment[] = [
  ...
  { time: "01:35", username: "RicardoViagens", message: "lucas, da pra colocar a logo e as cores da minha agencia?" },
  { time: "01:55", username: "LeticiaViajante", message: "Da sim Ricardo! Eu ja uso e fica mt bom" },
  { time: "02:15", username: "AlinePeloMundo", message: "nossa essa IA vai economizar mt tempo de postagem" },
  { time: "02:35", username: "RobertoTrilhas", message: "lucas, os criativos ja vem no formato de reels?" },
  { time: "02:55", username: "CarlaTurismo", message: "ja sim roberto, fica perfeito" },
  { time: "03:15", username: "GuiDoDestino", message: "chocada com a velocidade q gera as fotos com preco" },
  { time: "03:35", username: "RafaDeFerias", message: "ja sou aluna do elite o suporte é top demais msm" },
  { time: "03:55", username: "TiagoTurismo", message: "top" },
  { time: "04:15", username: "MariEmJericoacoara", message: "kd o preço? " },
  { time: "04:35", username: "BrunoPeloGlobo", message: "concorrente vai odiar isso kkk" },
  { time: "04:55", username: "DiegoExpedicoes", message: "como faco pra acessar o gerador com as IAs lucas?" },
  { time: "05:15", username: "LeoMundoAfora", message: "escolhe a foto de Jeri" },
  { time: "05:35", username: "SandraRoteiros", message: "funciona pra quem ta comecando do zero?" },
  { time: "05:55", username: "RenataPeloMundo", message: "tem q ter notebook ou da pra fazer tudo pelo celular?" },
  { time: "06:15", username: "ValdirTur", message: "dá pra gerar quantos anuncios por dia?" },
  { time: "06:35", username: "BiaExplora", message: "como faz pra assinar? libera o link logo lucas rs" },
  { time: "06:55", username: "MuriloTrilhas", message: "isso ajuda mt quem nao sabe usar o canva do zero" },
  { time: "07:15", username: "KarinaViagens", message: "dá pra usar fotos proprias ou so as da IA?" },
  { time: "07:35", username: "DuduPeloMundo", message: "tem destinos internacionais tbm?" },
  { time: "07:55", username: "ThiagoMochileiro", message: "jeri fica lindo dms na fabrica" },
  { time: "08:15", username: "FernandaRoteiros", message: "Consigo mudar as cores dps?" },
  { time: "08:35", username: "PatriciaLemosAgente", message: "ja quero assinar hj com desconto" },
];
