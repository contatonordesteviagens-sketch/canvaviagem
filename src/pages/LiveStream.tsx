...
const SCHEDULED_COMMENTS: ScheduledComment[] = [
  ...
  { time: "68:11", username: "RafaDestinos", message: "top top, valeu" },
  { time: "68:15", username: "VaneTurismo", message: "Show!" },
  { time: "68:18", username: "JulianaTur", message: "Ver teu whatsapp te" },
  { time: "68:20", username: "BetoTrips", message: "abraços até mais" }
];
