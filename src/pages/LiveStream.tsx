...
const SCHEDULED_COMMENTS: ScheduledComment[] = [
  ...
  { time: "03:25", username: "GuiDoDestino", message: "chocada com a velocidade q gera as fotos com preco" },
  { time: "03:45", username: "RicardoViagens", message: "lucas, da pra colocar a logo e as cores da minha agencia?" },
  { time: "04:05", username: "LeticiaViajante", message: "Da sim Ricardo! Eu ja uso e fica mt bom" },
  { time: "04:25", username: "AlinePeloMundo", message: "nossa essa IA vai economizar mt tempo de postagem" },
  { time: "04:45", username: "RobertoTrilhas", message: "lucas, os criativos ja vem no formato de reels?" },
  { time: "05:05", username: "CarlaTurismo", message: "ja sim roberto, fica perfeito" },
  { time: "05:25", username: "TiagoTurismo", message: "top" },
  { time: "05:45", username: "MariEmJericoacoara", message: "kd o preço? " },
  { time: "06:05", username: "DiegoExpedicoes", message: "como faco pra acessar o gerador com as IAs lucas?" },
  { time: "06:25", username: "LeoMundoAfora", message: "escolhe a foto de Jeri" },
  { time: "06:45", username: "SandraRoteiros", message: "funciona pra quem ta comecando do zero?" },
  { time: "07:05", username: "RenataPeloMundo", message: "tem q ter notebook ou da pra fazer tudo pelo celular?" },
  { time: "07:25", username: "ValdirTur", message: "dá pra gerar quantos anuncios por dia?" },
  { time: "07:45", username: "BiaExplora", message: "como faz pra assinar? libera o link logo lucas rs" },
  { time: "08:05", username: "MuriloTrilhas", message: "isso ajuda mt quem nao sabe usar o canva do zero" },
  { time: "08:25", username: "KarinaViagens", message: "dá pra usar fotos proprias ou so as da IA?" },
  { time: "08:45", username: "DuduPeloMundo", message: "tem destinos internacionais tbm?" },
  { time: "09:05", username: "ThiagoMochileiro", message: "jeri fica lindo dms na fabrica" },
  { time: "09:25", username: "FernandaRoteiros", message: "Consigo mudar as cores dps?" },
  { time: "09:45", username: "PatriciaLemosAgente", message: "ja quero assinar hj com desconto" },
];
