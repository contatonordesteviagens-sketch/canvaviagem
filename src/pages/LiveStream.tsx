...
const SCHEDULED_COMMENTS: ScheduledComment[] = [
  { time: "00:18", username: "Fabiotravell", message: "opa cheguei" },
  { time: "00:26", username: "Jr99", message: "boraaa" },
  { time: "00:40", username: "AnaPeloMundo", message: "São paulo Capital" },
  { time: "00:47", username: "PedroViagens", message: "São Paulo Sorocaba" },
  { time: "00:54", username: "TripsByGabi", message: "Dourado MS" },
  { time: "00:58", username: "Let_Viajante", message: "Rio Grande do Sul" },
  { time: "01:03", username: "VaneMundial", message: "Ceará" },
  { time: "01:08", username: "CarlosTrip", message: "Maringá" },
  { time: "01:13", username: "MariEmJericoacoara", message: "Ouvindo bem sim" },
  { time: "01:15", username: "AmandaTurismo", message: "audio ótimo, bora!" },
  { time: "01:19", username: "DiegoExpedicoes", message: "audio top, to ansioso!" },
  { time: "01:29", username: "GiseleDestinos", message: "Assino o canva viagem uso todo dia me salva demais" },
  { time: "01:54", username: "BrunoPeloGlobo", message: "Assino o Canva viagem mas quero saber dessa nova" },
  { time: "02:47", username: "RafaDeFerias", message: "Cheguei Lucas aqui da Bahia" },
  { time: "02:52", username: "LeoMundoAfora", message: "Sim tá travando" },
  { time: "02:57", username: "SandraRoteiros", message: "Aqui tá travando achei que era minha internet" },
  { time: "03:02", username: "ThiagoMochileiro", message: "audio perfeito mas video travando" },
  { time: "03:25", username: "GuiDoDestino", message: "travou teu video" },
  { time: "03:39", username: "ValdirTur", message: "travando a tela" },
  { time: "04:03", username: "KarinaViagens", message: "Video perfeito" },
  { time: "04:10", username: "Let_Viajante", message: "Agora sim tá perfeito" },
  { time: "04:30", username: "AlinePeloMundo", message: "nossa essa IA vai economizar mt tempo de postagem" },
  { time: "04:50", username: "RobertoTrilhas", message: "lucas, os criativos ja vem no formato de reels?" },
  { time: "05:10", username: "SandraRoteiros", message: "ja sim roberto, fica perfeito" },
  { time: "05:28", username: "LeticiaViajante", message: "Sim tá ótimo o video aqui" },
  { time: "05:42", username: "CarlaTurismo", message: "Sim melhorou" },
  { time: "05:59", username: "PedroViagens", message: "Agora sim ta perfeito o video e audio tbm" },
  { time: "06:15", username: "TiagoTurismo", message: "top" },
  { time: "06:35", username: "MariEmJericoacoara", message: "kd o preço? " },
  { time: "06:55", username: "DiegoExpedicoes", message: "como faco pra acessar o gerador com as IAs lucas?" },
  { time: "07:15", username: "LeoMundoAfora", message: "escolhe a foto de Jeri" },
  ...
  { time: "07:55", username: "RenataPeloMundo", message: "tem q ter notebook ou da pra fazer tudo pelo celular?" },
  { time: "08:02", username: "TatiViajante", message: "concordo" },
  { time: "08:05", username: "BetoExplora", message: "tem razão cliente percebe" },
  { time: "08:15", username: "ValdirTur", message: "dá pra gerar quantos anuncios por dia?" },
  ...
  { time: "08:35", username: "BiaExplora", message: "como faz pra assinar? libera o link logo lucas rs" },
  { time: "08:55", username: "MuriloTrilhas", message: "isso ajuda mt quem nao sabe usar o canva do zero" },
  { time: "09:15", username: "KarinaViagens", message: "dá pra usar fotos proprias ou so as da IA?" },
  { time: "09:35", username: "DuduPeloMundo", message: "tem destinos internacionais tbm?" },
  { time: "09:55", username: "ThiagoMochileiro", message: "jeri fica lindo dms na fabrica" },
  { time: "10:15", username: "FernandaRoteiros", message: "Consigo mudar as cores dps?" },
  ...
  { time: "10:35", username: "PatriciaLemosAgente", message: "ja quero assinar hj com desconto" },
  { time: "17:45", username: "MarcosMilhas", message: "ver um anúncio entra em contato cria uma certa confiança e comprar" },
  { time: "19:00", username: "DaniloMochileiro", message: "acontece muito comigo isso" },
  { time: "22:00", username: "ValDestinos", message: "eu não aguento mais curiosos" },
  { time: "22:15", username: "CarolTurista", message: "eu" },
  { time: "22:18", username: "RodrigoTrips", message: "eu" },
  { time: "22:23", username: "AmandaPeloMundo", message: "eu" },
