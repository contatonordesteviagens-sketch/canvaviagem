    ...
    <div className="min-h-screen bg-[#050812] text-white font-sans flex flex-col">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#050812]/90 px-4 py-3 backdrop-blur-md sm:px-6">
        <div className="mx-auto flex w-full items-center justify-between gap-4">
          ...
          <Link
            to="/"
            className="inline-flex min-h-[40px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2 text-sm font-bold text-slate-200 transition-colors hover:bg-white/[0.08] hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400"
          >
      ...
      <main className="flex-1 w-full px-4 py-6 sm:px-8 sm:py-8 overflow-hidden">
        <TutorialSection />
      </main>
    </div>
  );
