...
const COMPARISON = [
  { feature: "Investimento",  outroPack: "R$ 197 uma vez", design: "R$ 1.500 / mês", us: "A partir de R$ 197 / ano" },
  ...
  return (
    <div style={{ background: T.bg, color: T.text, minHeight: "100vh", overflowX: "hidden",
      ...
      <section style={{ padding: "16px 20px 40px", textAlign: "center", position: "relative",
        ...
        <Reveal delay={0.1}>
          <div style={{ margin: "32px auto", maxWidth: 1000, position: "relative" }}>
            <div style={{
              borderRadius: "20px", 
              overflow: "hidden", 
              boxShadow: `0 24px 80px ${T.accent}44`,
              border: `2px solid ${T.accent}55`,
              background: T.bgDeep
            }}>
              <img 
                src="/site-canva-viagem.webp" 
                alt="Canva Viagem Landing" 
                style={{ width: "100%", height: "auto", display: "block" }} 
              />
            </div>
            
            <div style={{ marginTop: 24, display: "flex", justifyContent: "center", gap: 16, flexWrap: "wrap" }}>
              <button onClick={() => checkout("elite_annual")} style={{
                background: `linear-gradient(135deg, ${T.accent}, #FF6600)`,
                color: "#fff", border: "none", padding: "18px 36px", fontSize: 18,
                fontWeight: 900, borderRadius: 14, cursor: "pointer",
                boxShadow: `0 8px 32px ${T.accent}66`, textTransform: "uppercase"
              }}>
                Acessar Canva Viagem Agora
              </button>
            </div>
          </div>
        </Reveal>
